...
HttpPheClient::HttpPheClient(const std::string &appToken, const std::string &serviceAddress)
        : appToken(appToken),
          serviceAddress(serviceAddress) {}

void HttpPheClient::enrollAccount(build::EnrollmentRequest enrollmentRequest) {
